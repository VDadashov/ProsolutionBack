...
namespace ProSolution.BL.Validators.Blogs.BlogReviews.BlogReviewReplays
{
    public class BlogReviewReplyCreateDtoValidator : AbstractValidator<BlogReviewReplyCreateDto>
    {
        public BlogReviewReplyCreateDtoValidator()
        {
            RuleFor(x => x.Text)
            ...
            RuleFor(x => x.BlogReviewId)
                .NotEmpty().WithMessage("BlogReviewId is required.");
        }
    }
}
